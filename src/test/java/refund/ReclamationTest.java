...
public class ReclamationTest {
    ...
    @Test
    public void testSetMontantReclamationMontantValide()
    ...
    public void testSetMontantReclamationMontantDecimalesInvalide()
            throws ReclamationException {
    ...
    @Test(expected = ReclamationException.class)
    public void testSetMontantReclamationMontantSeparateurInvalide()
            throws ReclamationException {
    ...
    @Test(expected = ReclamationException.class)
    public void testSetMontantReclamationMontantDeviseInvalide()
            throws ReclamationException {
        reclam.setMontantReclamation("100.00£");
