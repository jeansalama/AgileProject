...
public class StatsTest {
    ...
    public static final String CONTENU_1 = "Statistiques: "
    ...
    public static final String CONTENU_2 = "Statistiques: "
    ...
    public static final String CONTENU_3 = "\nSoins déclarés: "
            + "\n Massothérapie (0) : "
            + "\n    total : 3"
            + "\n    montant maximal réclamé : 100.00$"
            + "\n    moyenne des montants réclamés : 133.33$"
    ...
    public static final String CONTENU_4 = "\nSoins déclarés: "
            + "\n Massothérapie (0) : "
            + "\n    total : 0"
            + "\n    montant maximal réclamé : 0.00$"
            + "\n    moyenne des montants réclamés : 0.00$"
    ...
    public void testAfficherStatsNonVides() {
        assertEquals(CONTENU_1, Stats.afficherStats(stats));
    }
    
    @Test
    public void testAfficherStatsVides() {
        assertEquals(CONTENU_2, Stats.afficherStats(statsVides));
    }
    ...
    public void testAfficherSoinsNonVides() {
        assertEquals(CONTENU_3, Stats.afficherSoins(soins));
    }
    
    @Test
    public void testAfficherSoinsVides() {
        assertEquals(CONTENU_4, Stats.afficherSoins(soinsVides));
    }
